...
const markdownOptions = {
  overrides: {
    p: {
      component: (props: any) => <p className="text-[15px] text-slate-700 leading-[1.8] mb-8" {...props} />
    },
    ul: {
...
console.log('Updated AcademyMasterclassPage markdown options spacing');
