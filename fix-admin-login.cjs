...
// Ensure Eye, EyeOff, AlertTriangle are imported
if (!code.includes('Eye, EyeOff, AlertTriangle')) {
    code = code.replace("import { Search, Sparkles, Loader2,", "import { Search, Sparkles, Loader2, Eye, EyeOff, AlertTriangle,");
}
