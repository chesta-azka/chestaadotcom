  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
      ...
      <div className="lg:col-span-7 space-y-12">
        {project.overview && (
          <article className="bg-slate-50/90 p-8 sm:p-10 rounded-xl border border-slate-200 shadow-xs">
            <div className="flex items-center gap-2 text-purple-700 font-mono text-xs font-bold uppercase tracking-widest mb-4">
              <BookOpen size={16} /> Bab 1: Latar Belakang &amp; Drama Permasalahan Klien
            </div>
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-slate-900 mb-6 tracking-tight">
        ...
        {project.challenges && (
          <article className="bg-slate-900 text-white p-8 sm:p-10 rounded-xl shadow-xl border border-slate-800">
            <div className="flex items-center gap-2 text-purple-400 font-mono text-xs font-bold uppercase tracking-widest mb-4">
              <Sparkles size={16} /> Bab 2: Bedah Hambatan Arsitektur &amp; Kompleksitas Teknis
            </div>
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-white mb-6 tracking-tight">
              Menaklukkan Latensi Tinggi, Lonjakan Trafik, dan Kompleksitas Next.js 15
            </h2>
            <div className="prose prose-invert max-w-none text-slate-300 leading-relaxed sm:leading-loose space-y-5 text-[15px] sm:text-base">
              ...
              <p>
                Setiap hambatan teknis yang kami temui dalam proyek ini menuntut keputusan arsitektural yang presisi. Mulai dari konfigurasi Vercel Edge Middleware, optimalisasi kueri database relasional PostgreSQL, hingga manajemen state reaktif pada React. Tim engineering kami bekerja siang malam untuk memastikan bahwa sistem tidak hanya berfungsi saat diuji di lingkungan lokal, namun juga tetap kokoh ketika dihantam ribuan permintaan akses simultan dari berbagai wilayah di Indonesia.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 mt-6 border-t border-slate-800">
                <div className="bg-slate-800/90 p-5 rounded-xl border border-slate-700">
                  <h3 className="font-mono text-xs font-bold uppercase tracking-wider text-purple-400 mb-2">Zero Downtime Migration</h3>
                ...
                <div className="bg-slate-800/90 p-5 rounded-xl border border-slate-700">
                  <h3 className="font-mono text-xs font-bold uppercase tracking-wider text-purple-400 mb-2">Memory Leak Prevention</h3>
        ...
        {project.solution && (
          <article className="bg-purple-50/70 p-8 sm:p-10 rounded-xl border border-purple-200 shadow-xs">
            <div className="flex items-center gap-2 text-purple-800 font-mono text-xs font-bold uppercase tracking-widest mb-4">
        ...
        {project.impact && (
          <article className="p-8 sm:p-10 rounded-xl bg-gradient-to-br from-purple-950 to-slate-900 text-white shadow-xl">
            <div className="flex items-center gap-2 text-purple-300 font-mono text-xs font-bold uppercase tracking-widest mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-slate-200">
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200">
            <h3 className="text-xs font-mono font-bold uppercase tracking-widest text-slate-900 mb-4">Teknologi yang Digunakan</h3>
            <div className="flex flex-wrap gap-2">
              {project.techStack.map(tech => (
                <span key={tech} className="px-3 py-1.5 bg-white border border-slate-200 rounded-xl text-xs font-medium text-slate-700 shadow-xs">
                  {tech}
                </span>
              ))}
            </div>
          ...
          <div className="bg-purple-50/50 p-6 rounded-xl border border-purple-100">
            <h3 className="text-xs font-mono font-bold uppercase tracking-widest text-purple-900 mb-4">Fitur Utama Sistem</h3>
        ...
        <div className="bg-slate-900 text-white rounded-xl p-8 sm:p-10 shadow-lg flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-lg font-display font-bold text-white mb-2">Ingin Hasil Serupa untuk Bisnis Anda?</h3>
            <p className="text-xs text-slate-300 leading-relaxed">Diskusikan kebutuhan arsitektur digital dan estimasi proyek Anda langsung dengan Principal Engineer.</p>
          </div>
          <a 
            ...
            className="inline-flex items-center justify-center gap-2 py-3 px-6 bg-purple-600 hover:bg-purple-700 text-white text-xs font-mono font-bold uppercase tracking-wider rounded-xl transition-colors shadow-sm shrink-0 cursor-pointer"
          >
      ...
      <div className="lg:col-span-5 lg:sticky lg:top-32 space-y-6">
        <div className="bg-slate-50 border border-slate-200 p-6 rounded-xl shadow-sm space-y-6">
          <div className="flex items-center justify-between pb-4 border-b border-slate-200">
            <span className="text-xs font-mono font-bold uppercase tracking-widest text-purple-700">Project Walkthrough Gallery</span>
            ...
            {walkthroughImages.map((imgUrl, idx) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                  <span className="text-white text-xs font-mono font-bold tracking-wider bg-black/60 backdrop-blur-md px-3 py-1 rounded-xl">
          ...
          <div className="pt-4 border-t border-slate-200 text-xs text-slate-500 space-y-2 font-mono">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-slate-700 font-bold">WebP + Blur-Up Lazy</span>
            </div>
            <div className="flex justify-between">
              <span>Architecture:</span>
              <span className="text-purple-600 font-bold">Next.js 15 &amp; Agentic AI</span>
            </div>
          </div>
        </div>
      </div>
