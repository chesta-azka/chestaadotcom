...
export default function SparkleOverlay() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      if (Math.random() > 0.4) return; // 60% chance to skip for performance
  ...
  return (
    <div ref={containerRef} className="pointer-events-none absolute inset-0 z-50 overflow-hidden rounded-full">
      <AnimatePresence>
