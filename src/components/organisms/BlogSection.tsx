              ...
              >
                <div className="w-full h-40 overflow-hidden rounded-2xl mb-6 border border-white/5 relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#06080F]/60 to-transparent p-4 flex items-end">
                    <span className="text-[9px] font-mono text-white/50 tracking-widest uppercase">Visual Perspective</span>
                  </div>
                </div>
                ...
                <h3 className="text-xl font-display font-medium text-white leading-snug mb-3 group-hover:text-green-400 transition-colors tracking-tight line-clamp-2 text-left">
                  {art.title}
                </h3>
                <p className="text-sm text-gray-400 leading-relaxed font-sans line-clamp-2 mb-6 text-left">
                  {art.desc}
                </p>
                
                <Link 
                  to={`/blog?read=${art.slug}&origin=home`} 
                  className="mt-auto pt-4 flex items-center gap-2 text-xs font-sans font-semibold tracking-widest uppercase text-[#D4FF00] opacity-80 group-hover:opacity-100 transition-opacity"
                >
                  Baca Selengkapnya
