            ...
            >
              ...
              >
                ...
                <a 
                  ...
                  onClick={() => setIsOpen(false)}
                  className="inline-flex text-[10px] font-mono font-bold text-[#0A0F1C] bg-[#D4FF00] px-8 py-3.5 rounded-full hover:bg-[#c2e600] transition-colors tracking-wider uppercase w-full justify-center"
                >
                  Get Started
                </a>
              </motion.div>
