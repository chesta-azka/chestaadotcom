  ...
  return (
    <section id="insights" className="py-16 md:py-24 relative overflow-hidden bg-white border-b border-slate-100">
      <div className="mx-auto max-w-7xl px-6 relative z-10 w-full">
        ...
        >
          <div>
            <span className="flex items-center gap-2 text-[#4f46e5] font-mono font-semibold text-xs uppercase tracking-widest mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {insights.map((insight, i) => (
              <motion.a 
                ...
                rel="noreferrer"
                key={i} 
                className="group cursor-pointer relative flex flex-col h-full bg-white p-6 md:p-8 rounded-3xl border border-slate-200/80 hover:border-[#4f46e5]/40 hover:shadow-xl transition-all duration-300 shadow-sm"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <h3 className="text-lg font-display font-medium text-slate-900 leading-snug mb-3 group-hover:text-[#4f46e5] transition-colors tracking-tight text-left">
                  {insight.title}
                </h3>
                ...
                <div className="mt-auto pt-4 flex items-center justify-between text-xs font-mono font-semibold tracking-wider text-[#4f46e5] border-t border-slate-100">
