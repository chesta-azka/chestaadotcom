  ...
  if (success) {
    return (
      <div className="bg-purple-600 rounded-xl p-8 text-center text-white flex flex-col items-center">
        ...
        <h3 className="text-2xl font-medium mb-2">Terima Kasih!</h3>
  ...
  return (
    <div className="bg-purple-50/50 border border-purple-100 rounded-xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12 shadow-sm">
      <div className="flex-1 text-slate-900">
        <span className="text-purple-700 font-mono text-xs uppercase tracking-wider font-medium inline-block mb-2">
          Update &amp; Wawasan
        </span>
        <h3 className="text-2xl md:text-3xl font-display font-medium mb-2">Newsletter Digital</h3>
