...
export default function StatsSection() {
  return (
    <section className="py-2 md:py-4 relative overflow-hidden bg-transparent">
      <div className="w-full relative z-10 border-y border-white/5 bg-[#131825]/40 backdrop-blur-xl">
        <div className="grid grid-cols-2 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-white/10">
          {stats.map((stat, i) => (
            <motion.div
              key={i}
              className="py-6 md:py-8 px-4 text-center flex flex-col items-center justify-center relative group"
            ...
            >
              ...
              <div className="text-4xl md:text-6xl lg:text-7xl font-display font-medium tracking-tight text-white mb-2 md:mb-4 relative z-10">
                <Counter from={0} to={stat.value} delay={i * 0.15} />
