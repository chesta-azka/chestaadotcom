      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16 md:mb-24">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4.5 py-2.5 rounded-full bg-white/[0.03] border border-slate-100 mx-auto text-xs font-mono tracking-widest text-[#4f46e5] uppercase mb-6"
          >
            <Star size={12} />
        ...
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative bg-white backdrop-blur-xl border border-slate-200 rounded-[2.5rem] p-8 md:p-12 overflow-hidden shadow-2xl"
          >
            {/* Glow accent */}
