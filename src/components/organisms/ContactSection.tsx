...
const packagesList: ChoicePackage[] = [
  {
    title: "UMKM Starter",
    price: "Rp450K+",
    description: "Visual landing page satu layar berkecepatan tinggi, dioptimalkan untuk memicu tautan bio Instagram & WhatsApp.",
    features: [
  ...
  },
  {
    ...
    price: "Rp1.2M+",
    description: "Kehadiran digital multi-halaman terintegrasi untuk bisnis korporat lokal maupun klinik kecantikan.",
    features: [
      "Halaman Detail & Portofolio",
      "Tampilan Visual Apple Aesthetic",
      "Kecepatan Load di Bawah 1 Detik",
      "Analisis Traffic & Peta Lokasi"
    ],
    waMessage: "Halo Mas Chesta! Saya tertarik memesan Paket Bisnis Premium seharga Rp1.2M+. Bolehkah konsultasi lebih lanjut?"
  },
  {
    title: "Custom Performance Hub",
    price: "Bespoke",
    description: "Arsitektur performa tinggi khusus dengan integrasi interaktif unik, database, dan visualisasi kustom.",
    features: [
      "Integrasi API & Database Awet",
      "Visual Animasi Frame Istimewa",
      "Optimasi Ekstrim Skor Core Web",
      "Konsultasi Strategis 1-on-1"
    ],
    waMessage: "Halo Mas Chesta! Saya punya konsep kustom yang butuh sistem khusus. Boleh dong jadwalkan waktu konsultasi awal?"
  }
];
