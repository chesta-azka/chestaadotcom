  ...
  return (
    <section className="py-24 md:py-32 bg-transparent relative">
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="md:hidden flex items-center justify-center gap-2 text-purple-500 mb-4 animate-pulse">
        ...
        <div className="overflow-x-auto pb-8 hide-scrollbar cursor-grab active:cursor-grabbing snap-x snap-mandatory">
          <div className="min-w-[900px] w-full pr-4 md:pr-0">
            {/* Table Header */}
            <div className="grid grid-cols-12 gap-4 mb-8 sticky top-0 bg-transparent backdrop-blur-xl z-20 py-4 border-b border-slate-200/50">
              ...
              <div className="col-span-3 relative">
                <div className="absolute -inset-1 bg-gradient-to-b from-purple-500 to-purple-600 rounded-[1.25rem] opacity-20 blur-sm"></div>
                <div className="bg-purple-600 border border-purple-500 rounded-2xl p-6 text-center h-full flex flex-col justify-between relative shadow-xl shadow-purple-900/10">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-white text-purple-600 text-[10px] font-bold uppercase tracking-widest py-1 px-3 rounded-full shadow-sm whitespace-nowrap">
                    Paling Populer
                  </div>
                  <div>
                      ...
                      <div key={itemIdx} className="grid grid-cols-12 gap-4 py-3 hover:bg-slate-50/50 rounded-xl px-2 transition-colors group">
                        ...
                        <div className="col-span-3 flex items-center justify-center text-center">
                          {typeof item.pro === 'boolean' ? (
                            item.pro ? <Check size={18} className="text-purple-600 font-bold" /> : <Minus size={18} className="text-slate-300" />
                          ) : (
                            <span className="text-sm font-sans text-purple-600 font-bold">{item.pro}</span>
                          )}
                        </div>
