        ...
        {related.map((service, i) => (
          ...
          >
            <Link
              ...
              className="group block p-6 rounded-xl bg-white/70 backdrop-blur-[16px] backdrop-saturate-[180%] border border-white/40 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] hover:bg-white hover:shadow-lg transition-all"
            >
              <div className="flex items-center gap-4 mb-3">
                <div className="w-10 h-10 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600">
                  <service.icon size={20} strokeWidth={1.5} />
                </div>
                <h4 className="font-display font-black text-lg text-slate-900 group-hover:text-purple-600 transition-colors">
                  {service.title}
                </h4>
              </div>
