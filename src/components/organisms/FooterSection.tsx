...
export default function FooterSection() {
  return (
    <footer className="pt-24 pb-12 bg-transparent text-gray-600 border-t border-gray-100 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-5 space-y-8 pr-8">
            <Link to="/" onClick={() => window.scrollTo(0,0)} className="inline-flex items-center gap-3 group">
              <div className="w-12 h-12 rounded-xl bg-gray-50 border border-gray-200 flex items-center justify-center group-hover:border-[#4f46e5]/40 transition-colors duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
              ...
              <span className="font-display text-2xl font-extrabold tracking-tight leading-none text-gray-900">
                CHESTA<span className="text-[#4f46e5]">.</span>
              </span>
            </Link>
            <p className="text-base font-sans leading-relaxed text-gray-600 max-w-sm">
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/chestadotcom" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-gray-50 border border-gray-200 flex items-center justify-center hover:bg-[#4f46e5] hover:text-white hover:border-[#4f46e5] transition-all duration-300">
                <Instagram size={20} strokeWidth={1.5} />
              </a>
              <a href="https://wa.me/6282125447232" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-gray-50 border border-gray-200 flex items-center justify-center hover:bg-[#4f46e5] hover:text-white hover:border-[#4f46e5] transition-all duration-300">
                <MessageCircle size={20} strokeWidth={1.5} />
              </a>
              <a href="mailto:chestadotcom@gmail.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-gray-50 border border-gray-200 flex items-center justify-center hover:bg-[#4f46e5] hover:text-white hover:border-[#4f46e5] transition-all duration-300">
          ...
          <div className="lg:col-span-2 lg:col-start-7">
            <h4 className="text-gray-900 font-sans font-bold tracking-widest uppercase text-[11px] mb-8">Layanan Utama</h4>
            <ul className="space-y-4 text-sm font-sans text-gray-600">
              ...
              <li className="pt-2">
                <Link to="/services" onClick={() => window.scrollTo(0,0)} className="text-gray-900 hover:text-[#4f46e5] transition-colors flex items-center gap-1 group w-max">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-gray-900 font-sans font-bold tracking-widest uppercase text-[11px] mb-8">Eksplorasi</h4>
            <ul className="space-y-4 text-sm font-sans text-gray-600">
          ...
          {/* Column 4: Contact */}
          <div className="lg:col-span-2">
            <h4 className="text-gray-900 font-sans font-bold tracking-widest uppercase text-[11px] mb-8">Informasi</h4>
            <ul className="space-y-5 text-sm font-sans text-gray-600">
        ...
        {/* Big Text Bottom */}
        <div className="w-full border-t border-gray-100 pt-12 mt-12 flex flex-col items-center">
            {/* Massive typography for decorative brutalism aesthetic */}
            <div className="w-full mb-12 flex justify-center overflow-hidden">
                <h2 className="text-[12vw] font-display font-extrabold tracking-tighter text-gray-900/[0.03] leading-none select-none pointer-events-none whitespace-nowrap">
                  CHESTADOTCOM
                </h2>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-6 text-[10px] font-sans tracking-widest uppercase">
              <div className="flex items-center gap-4">
                  <span className="text-gray-900/30">© 2026 CHESTADOTCOM. ALL RIGHTS RESERVED.</span>
              </div>
              <div className="flex gap-8">
                 <Link to="/" className="text-gray-900/30 hover:text-gray-900 transition-colors">Privacy Policy</Link>
                 <Link to="/" className="text-gray-900/30 hover:text-gray-900 transition-colors">Terms of Service</Link>
              </div>
            </div>
        </div>
      </div>
