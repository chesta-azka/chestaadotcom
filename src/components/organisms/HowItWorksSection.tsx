    ...
    <section className="py-32 bg-transparent relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <div className="text-6xl md:text-8xl font-display font-medium tracking-tight text-white leading-[1.05] flex flex-wrap">
            <TextRevealSmooth 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 lg:gap-24">
          {steps.map((s, i) => (
            ...
            >
              ...
              <h3 className="text-2xl lg:text-3xl font-display font-medium tracking-tight text-white mb-4">{s.title}</h3>
              <p className="text-gray-400 font-sans leading-relaxed text-base">{s.desc}</p>
              
              {/* Animated Progress bar */}
              <motion.div 
                className="absolute top-0 left-0 h-[2px] bg-gradient-to-r from-purple-400 to-indigo-500"
                initial={{ width: 0 }}
