      ...
      <div className="p-6 rounded-xl bg-white border border-purple-100 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5 mb-1">
            ...
            <div>
              <h2 className="text-xl font-display font-semibold text-slate-900 tracking-tight">Client Vault & Deliverables</h2>
            ...
            >
              <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-medium text-slate-900 text-base">Tambah Item Vault Baru</h3>
                </div>
                <button
                  onClick={() => setIsAddModalOpen(false)}
              ...
              <form onSubmit={handleManualAdd} className="space-y-4 pt-4">
                <div>
                  <label className="block text-xs font-medium text-slate-700 mb-1.5">Nama Item / Dokumen</label>
                  <input
                    type="text"
                    required
                    value={newTitle}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-medium text-slate-700 mb-1.5">Tipe Kategori</label>
                    <select
                      value={newType}
                  ...
                  <div>
                    <label className="block text-xs font-medium text-slate-700 mb-1.5">Status Awal</label>
                    <select
                      value={newStatus}
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-700 mb-1.5">Tautan File / Cloud URL</label>
                  <input
                    type="text"
                    required
                    value={newFileUrl}
                ...
                <div className="flex justify-end gap-3 pt-3">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2 text-xs font-medium text-white bg-gradient-to-r from-purple-800 to-indigo-900 hover:from-purple-700 hover:to-indigo-800 rounded-xl shadow-xs cursor-pointer"
                  >
                    Simpan ke Vault
                  </button>
                </div>
