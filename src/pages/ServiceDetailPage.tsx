...
function renderSlideGraphics(slug: string, pointIndex: number) {
  ...
  if (slug === 'pembuatan-website') {
    switch (pointIndex) {
      case 0: // UI/UX
        return (
          <div className="w-full h-full flex flex-col justify-between p-6 bg-white rounded-2xl border border-gray-100 font-mono select-none text-left">
            ...
            <div className="grid grid-cols-3 gap-3 my-auto">
              <div className="aspect-square bg-white/[0.02] border border-gray-200 rounded-xl flex flex-col items-center justify-center p-2 relative overflow-hidden group">
                <span className="text-[18px] text-[#4f46e5] font-bold">&lt;/&gt;</span>
                <span className="text-[8px] text-gray-600 mt-1">Grid System</span>
              </div>
              ...
              <div className="aspect-square bg-white/[0.02] border border-gray-200 rounded-xl flex flex-col items-center justify-center p-2 relative overflow-hidden group">
                ...
                <span className="text-[8px] text-gray-600 mt-1">No Template</span>
              </div>
            </div>
        ...
        return (
          <div className="w-full h-full flex flex-col justify-between p-6 bg-white rounded-2xl border border-gray-100 font-mono select-none text-left">
            ...
            <div className="my-auto text-center space-y-2">
              ...
              <p className="text-[10px] text-gray-600">OPTIMAL LOADING LATENCY</p>
        ...
        return (
          <div className="w-full h-full flex flex-col justify-between p-6 bg-white rounded-2xl border border-gray-100 font-mono select-none text-left">
            ...
            <div className="my-auto space-y-2.5">
              <div className="p-2 border border-[#4f46e5]/10 bg-gray-50 rounded-lg text-left">
                <span className="text-[#4f46e5] text-[9px] block">https://bisnis-kamu.com</span>
                <span className="text-gray-900 text-[11px] font-sans font-bold block mt-0.5">Brand Paling Terpercaya di Indonesia</span>
                <p className="text-gray-600 text-[10px] font-sans line-clamp-1 mt-0.5">Clean, cepat, premium, dan langsung terhubung ke layanan kami...</p>
              </div>
              <div className="flex gap-2 text-[9px]">
                <span className="px-2 py-0.5 bg-gray-100 rounded text-gray-600 border border-gray-100">#1 ON GEOGRAPHY</span>
        ...
        return (
          <div className="w-full h-full flex flex-col justify-between p-6 bg-white rounded-2xl border border-gray-100 font-mono select-none text-left">
            ...
            <div className="my-auto flex justify-center">
              <div className="w-[125px] h-[150px] border border-gray-200 rounded-2xl p-2 bg-gray-100 relative overflow-hidden flex flex-col justify-between">
                <div className="absolute top-1 left-1/2 -translate-x-1/2 w-8 h-2 bg-gray-200 rounded-full" />
                <div className="w-full h-1 bg-[#4f46e5] mt-3 rounded-full" />
                <div className="space-y-1.5 my-auto">
                  <div className="w-full h-6 bg-white/[0.02] border border-gray-100 rounded flex items-center px-1">
                    <span className="text-[5px] text-gray-600 truncate">💬 TARGET CHAT WA</span>
                  </div>
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between p-6 bg-white rounded-2xl border border-gray-100 font-mono select-none text-left">
      ...
      <div className="my-auto space-y-3 p-3 bg-white/[0.01] border border-gray-100 rounded-xl text-left">
        <div className="flex items-center gap-2">
          <span className="w-1.5 h-1.5 rounded-full bg-[#4f46e5] animate-pulse" />
          <span className="text-[10px] text-gray-900 font-sans font-bold uppercase tracking-wide">DIGITAL COMPONENT {pointIndex + 1}</span>
        </div>
...
export default function ServiceDetailPage() {
  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-5xl mx-auto bg-transparent min-h-screen text-gray-900">
      <MetaTags 
      ...
      >
        <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-sans font-medium text-gray-600 tracking-widest uppercase text-center inline-block pt-1">
        ...
        <p className="text-base md:text-lg font-sans text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
          {service.desc}
        </p>
        <button 
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
        {service.points.map((pt, i) => (
            <motion.div 
                ...
                className="bg-gray-50 backdrop-blur-md border border-gray-100 p-8 rounded-3xl hover:border-gray-200 transition-colors text-left"
            >
                <div className="w-12 h-12 rounded-2xl bg-gray-100 text-[#4f46e5] flex items-center justify-center mb-6">
                    <CheckCircle2 size={24} />
                </div>
                <h3 className="text-lg font-bold font-sans mb-3 text-gray-900">{pt.title}</h3>
                <p className="text-sm font-sans text-gray-600 leading-relaxed">{pt.desc}</p>
            </motion.div>
        ))}
      </div>
      ...
      <div className="mb-32">
        <div className="text-center mb-10">
          <span className="text-[#4f46e5] font-mono text-[9px] uppercase tracking-[0.25em] inline-flex items-center gap-1.5 bg-gray-100 px-3 py-1 rounded-full border border-gray-200 mb-4 animate-pulse">
          ...
          <p className="text-xs text-gray-600 font-sans max-w-md mx-auto">Geser/swipe ke kiri atau kanan untuk menjelajahi komponen arsitektur premium kami pada perangkat pintar Anda.</p>
        </div>

        {/* Carousel Box */}
        <div className="max-w-4xl mx-auto bg-[#0B0F19]/60 border border-gray-100 rounded-3xl p-6 md:p-8 relative overflow-hidden backdrop-blur-md">
          ...
          >
            ...
            <div className="md:col-span-6 text-left flex flex-col justify-center space-y-4">
              ...
              <div className="bg-white/[0.02] border border-gray-100 rounded-2xl p-4 text-[11px] text-gray-500 font-sans leading-relaxed">
          ...
          <button 
            onClick={prevSlide}
            className="absolute left-4 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full border border-gray-200 bg-gray-100 flex items-center justify-center text-gray-600 hover:text-gray-900 hover:border-white/30 hover:bg-gray-100 transition-all hidden md:flex z-40 select-none font-bold"
          >
            &larr;
          </button>
          <button 
            onClick={nextSlide}
            className="absolute right-4 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full border border-gray-200 bg-gray-100 flex items-center justify-center text-gray-600 hover:text-gray-900 hover:border-white/30 hover:bg-gray-100 transition-all hidden md:flex z-40 select-none font-bold"
          >
            &rarr;
          </button>
        </div>
      ...
      <div className="mb-32">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch max-w-4xl mx-auto">
            ...
            <motion.div 
                ...
                viewport={{ once: true }}
                className="border border-gray-100 rounded-3xl p-6 md:p-8 bg-gray-100 opacity-50 grayscale"
            >
                <h3 className="text-xl font-display font-medium text-center mb-6 pb-6 border-b border-gray-200">{service.comparison.theirs.title}</h3>
            ...
            >
                ...
                <h3 className="text-xl font-display font-medium text-center mb-6 pb-6 border-b border-gray-200">{service.comparison.ours.title}</h3>
                <ul className="space-y-4 font-sans text-sm">
                    {service.comparison.ours.items.map((item, i) => (
                        <li key={i} className="flex gap-3 text-gray-900 items-start">
      ...
      <div className="mb-32">
        ...
        <div className="grid md:grid-cols-3 gap-6">
            {service.benefits.map((benefit, i) => (
                <div key={i} className="p-8 bg-gray-100 rounded-3xl border border-gray-100">
                    <h3 className="text-xl font-bold font-sans tracking-tight mb-3 text-gray-900 flex items-center gap-3">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#4f46e5] inline-block"/>
                        {benefit.title}
                    </h3>
                    <p className="text-sm font-sans text-gray-600 leading-relaxed">{benefit.desc}</p>
                </div>
            ))}
        </div>
      </div>
      ...
      <div className="mb-32 max-w-3xl mx-auto">
        <div className="text-center mb-12">
            <h2 className="text-3xl font-display font-medium tracking-tight text-gray-900 mb-4">Pertanyaan Seputar Layanan Ini</h2>
        </div>
        <div className="space-y-4">
            {service.faqs.map((faq, i) => {
                ...
                return (
                    <div 
                        key={i} 
                        className={`border border-gray-100 rounded-2xl bg-gray-50 backdrop-blur-md overflow-hidden transition-colors ${isOpen ? 'border-[#4f46e5]/30' : 'hover:border-gray-200 hover:bg-gray-50'}`}
                    >
                        <button
                            onClick={() => setOpenFaq(isOpen ? null : i)}
                            className="w-full flex items-center justify-between p-6 text-left"
                        >
                            <h4 className={`font-bold font-sans pr-8 transition-colors ${isOpen ? 'text-[#4f46e5]' : 'text-gray-900'}`}>
                                {faq.q}
                            </h4>
                            <div className={`shrink-0 w-8 h-8 rounded-full border flex items-center justify-center transition-all duration-300 ${isOpen ? 'border-[#4f46e5]/50 bg-[#4f46e5]/10 text-[#4f46e5] rotate-180' : 'border-gray-200 text-gray-600 bg-gray-100'}`}>
                        ...
                        <AnimatePresence>
                            {isOpen && (
                                ...
                                >
                                    <div className="px-6 pb-6 text-sm font-sans text-gray-600 leading-relaxed border-t border-gray-100 pt-4">
                                        {faq.a}
                                    </div>
                                </motion.div>
                            )}
            ...
            {SERVICES_DATA.filter(s => s.slug !== service.slug).map((s, i) => (
                ...
                >
                  <Link 
                    ...
                    className="group flex flex-col justify-between p-6 bg-gray-50 border border-gray-100 rounded-3xl hover:bg-gray-50 hover:border-gray-200 transition-all duration-300 h-full relative overflow-hidden"
                  >
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                      <div className="w-10 h-10 flex items-center justify-center bg-gray-100 rounded-xl text-gray-600 group-hover:text-[#4f46e5] transition-colors border border-gray-100 group-hover:border-[#4f46e5]/20">
                         <s.icon size={18} />
                      </div>
                      <div className="w-8 h-8 rounded-full border border-gray-100 flex items-center justify-center group-hover:bg-[#4f46e5] group-hover:border-[#4f46e5] transition-all duration-300">
                          <ChevronRight size={14} className="text-gray-500 group-hover:text-white transition-colors" />
                      </div>
                    </div>
                    <h4 className="text-base font-bold font-sans text-gray-200 tracking-tight relative z-10 group-hover:text-gray-900 transition-colors">{s.name}</h4>
                  </Link>
                </motion.div>
            ))}
        </div>
      ...
      <div className="mb-32">
        ...
        <p className="text-center text-xs text-gray-600 font-sans mb-8 max-w-lg mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          {CITIES.map((city) => (
            <Link
              ...
              className="group flex items-center justify-between p-3.5 bg-gray-50 border border-gray-100 rounded-xl hover:bg-gray-50 hover:border-[#4f46e5]/30 transition-all font-mono text-[10px] tracking-wider text-gray-600 hover:text-gray-900 cursor-pointer text-left overflow-hidden hover:scale-[1.02] duration-300"
            >
              <div className="flex items-center gap-2">
              ...
              <ChevronRight size={10} className="text-gray-600 group-hover:text-[#4f46e5] group-hover:translate-x-0.5 transition-all" />
            </Link>
          ))}
        </div>
      </div>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="text-center p-8 md:p-12 bg-gray-50 border border-gray-100 rounded-3xl relative overflow-hidden mb-8"
      >
        ...
        <h2 className="text-3xl md:text-4xl font-display font-medium tracking-tight mb-4 text-gray-900">
            Siap Memulai?
        </h2>
        <p className="text-gray-600 font-sans max-w-md mx-auto mb-8 leading-relaxed text-sm">Konsultasikan kebutuhan Anda bersama spesialis kami, gratis tanpa komitmen apapun.</p>
        <button 
          onClick={handleWhatsAppClick}
