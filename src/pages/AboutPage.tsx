              ...
              <div className="relative z-10 space-y-6">
                <div className="flex justify-between items-start">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full overflow-hidden border border-white/15 bg-slate-900">
                      <img 
                    ...
                    <div>
                      <h3 className="font-display font-bold text-white text-sm">CHESTA</h3>
                      <span className="font-mono text-[8px] text-gray-500 uppercase tracking-widest">Founder & Developer</span>
                    </div>
                  </div>
                  <span className="font-mono text-[8px] bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded border border-emerald-500/20 uppercase tracking-wider font-semibold">
                    AVAILABLE 2026
                  </span>
                </div>

                <div className="space-y-2 border-t border-b border-white/5 py-4 text-xs font-mono">
                  <div className="flex justify-between">
                    <span className="text-gray-500">Lokasi Penugasan:</span>
                    <span className="text-white text-right">Tangerang / Remote</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Harga Layanan:</span>
                    <span className="text-[#D4FF00]">Mulai Rp450.000</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Filosofi Hub:</span>
                    <span className="text-white text-right font-semibold">"Strictly High Conversion"</span>
                  </div>
                </div>

                <div className="space-y-2">
                  <span className="text-[9px] font-mono text-gray-500 block uppercase">Fokus Arsitektur Logic:</span>
                  <div className="flex flex-wrap gap-1.5">
                    {tools.map((t) => (
                      <span key={t} className="text-[9px] font-mono bg-white/5 px-2 py-0.5 rounded text-gray-300">
                        {t}
                      </span>
                    ))}
                  </div>
