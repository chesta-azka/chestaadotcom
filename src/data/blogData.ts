...
export const ALL_ARTICLES: Article[] = [
  {
    ...
    content: [
      ...
      "Masa depan otomasi ada di genggaman Anda. Mengadopsi teknologi AI sedini mungkin adalah kunci memenangkan persaingan bisnis modern."
    ]
  },
  {
